...
const ieDetect = navigator.userAgent.indexOf('MSIE') >= 0;
const initializeFirebase = ieDetect ? null : require('./push-notification');
...
export default {
  data() {
    if (this.$store.getters.user && !ieDetect) initializeFirebase();
